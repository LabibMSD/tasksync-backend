...
<head>
    ...
    <title>tasksync_backend API Documentation</title>

    <link href="https://fonts.googleapis.com/css?family=PT+Sans&display=swap" rel="stylesheet">

    <link rel="stylesheet" href="{{ asset("/docs/css/theme-elements.style.css") }}" media="screen">
    ...
    <script type="module">
        ...
        window.CodeJar = CodeJar;
            ...
            <script>
            var tryItOutBaseUrl = "http://tasksync.test";
            var useCsrf = Boolean();
            var csrfUrl = "/sanctum/csrf-cookie";
        </script>
        <script src="{{ asset("/docs/js/tryitout-5.3.0.js") }}"></script>
        <style>
...
<div class="sl-elements sl-antialiased sl-h-full sl-text-base sl-font-ui sl-text-body sl-flex sl-inset-0">
    ...
    <div class="sl-flex sl-items-center sl-mb-5 sl-ml-4">
            ...
            tasksync_backend API Documentation
        </h4>
    </div>
        ...
        <div class="sl-overflow-y-auto sl-w-full sl-bg-canvas-100">
            <div class="sl-my-3">
                                                ...
                                                <a class="ElementsTableOfContentsItem sl-block sl-no-underline"
                                                   href="#auth-POSTapi-auth-login">
                                                    POST api/auth/login
                                                                    ...
                                                                    <div class="expandable">
                                        <div class="sl-flex sl-items-center sl-h-md sl-pr-4 sl-pl-8 sl-bg-canvas-100 hover:sl-bg-canvas-200 sl-cursor-pointer sl-select-none"
                                             id="toc-item-auth-POSTapi-auth-logout">
                                            <div class="sl-flex-1 sl-items-center sl-truncate sl-mr-1.5 sl-p-0" title="POST api/auth/logout">
                                                <a class="ElementsTableOfContentsItem sl-block sl-no-underline"
                                                   href="#auth-POSTapi-auth-logout">
                        ...
                        <div title="Users" id="toc-item-users"
                             class="sl-flex sl-items-center sl-h-md sl-pr-4 sl-pl-4 sl-bg-canvas-100 hover:sl-bg-canvas-200 sl-cursor-pointer sl-select-none">
                            <a href="#users"
                               class="sl-flex-1 sl-items-center sl-truncate sl-mr-1.5 sl-p-0">Users</a>
                                                            <div class="sl-flex sl-items-center sl-text-xs expansion-chevrons">
                                    <svg aria-hidden="true" focusable="false" data-prefix="fas"
                                         data-icon="chevron-right"
                                         class="svg-inline--fa fa-chevron-right fa-fw sl-icon sl-text-muted"
                                                ...
                                                <a class="ElementsTableOfContentsItem sl-block sl-no-underline"
                                                   href="#users-GETapi-users">
                                                    GET api/users
                                                                    ...
                                                                    <div class="expandable">
                                        <div class="sl-flex sl-items-center sl-h-md sl-pr-4 sl-pl-8 sl-bg-canvas-100 hover:sl-bg-canvas-200 sl-cursor-pointer sl-select-none"
                                             id="toc-item-users-POSTapi-users">
                                            <div class="sl-flex-1 sl-items-center sl-truncate sl-mr-1.5 sl-p-0" title="POST api/users">
                                                <a class="ElementsTableOfContentsItem sl-block sl-no-underline"
                                                   href="#users-POSTapi-users">
                                                    POST api/users
                                                </a>
                                            </div>
                                                                                    </div>
...
<pre><code>This documentation is generated with [Knuckles](https://knuckleswtf.com) using the [Laravel package](https://github.com/knuckleswtf/scribe).</code></pre>

                <h1 id="authenticating-requests">Authenticating requests</h1>
<p>To authenticate requests, include an <strong><code>Authorization</code></strong> header with the value <strong><code>"Bearer 1|331Ixp7FInIkuZjI3RH4f6QrZCSCyDUMTk4IWYnh212eba86"</code></strong>.</p>
<p>All authenticated endpoints are marked with a <code>requires authentication</code> badge in the documentation below.</p>
<p>Authentication via the <strong><code>Authorization</code> header</strong>.</p>
            </div>
        </div>
    ...
    <div class="sl-stack sl-stack--vertical sl-stack--5 sl-flex sl-flex-col sl-items-stretch">
        ...
        <div class="sl-relative">
            <div title="http://tasksync.test/api/auth/register"
                ...
                >
                        ...
                        <div dir="rtl"
                             class="sl-overflow-x-hidden sl-truncate sl-text-muted">http://tasksync.test</div>
    ...
    <div class="sl-stack sl-stack--vertical sl-stack--1 sl-flex sl-flex-1 sl-flex-col sl-items-stretch sl-max-w-full sl-ml-2 ">
        <div class="sl-flex sl-items-center sl-max-w-full">
                ...
                <div class="sl-prose sl-markdown-viewer" style="font-size: 12px;">
            <p>The value and password must match.</p>
        </div>
                                            <div class="sl-stack sl-stack--horizontal sl-stack--2 sl-flex sl-flex-row sl-items-baseline sl-text-muted">
                <span>Example:</span> <!-- <span> important for spacing -->
                <div class="sl-flex sl-flex-1 sl-flex-wrap" style="gap: 4px;">
...
You can check the Dev Tools console for debugging information.</p>
    ...
    "http://tasksync.test/api/auth/register" \
...
$url = 'http://tasksync.test/api/auth/register';
...
response.json()</code></pre>                                        </div>
                                                            ...
                                                            <div class="sl-bg-canvas-100 example-request example-request-axios"
                                     style="display: none;">
                                    <div class="sl-px-0 sl-py-1">
                                        <div style="max-height: 400px;" class="sl-overflow-y-auto sl-rounded">
...
.catch(error =&gt; {
    ...
    <div class="sl-stack sl-stack--vertical sl-stack--5 sl-flex sl-flex-col sl-items-stretch">
        ...
        <div class="sl-relative">
            <div title="http://tasksync.test/api/auth/login"
                     class="sl-stack sl-stack--horizontal sl-stack--3 sl-inline-flex sl-flex-row sl-items-center sl-max-w-full sl-font-mono sl-py-2 sl-pr-4 sl-bg-canvas-50 sl-rounded-lg"
                >
                                            <div class="sl-text-lg sl-font-semibold sl-px-2.5 sl-py-1 sl-text-on-primary sl-rounded-lg"
                             style="background-color: black;"
    ...
    <div class="sl-stack sl-stack--vertical sl-stack--1 sl-flex sl-flex-1 sl-flex-col sl-items-stretch sl-max-w-full sl-ml-2 ">
        <div class="sl-flex sl-items-center sl-max-w-full">
                ...
                <div class="sl-prose sl-markdown-viewer" style="font-size: 12px;">
            <p>Must be a valid email address. The <code>email</code> of an existing record in the users table.</p>
        </div>
                                            <div class="sl-stack sl-stack--horizontal sl-stack--2 sl-flex sl-flex-row sl-items-baseline sl-text-muted">
                <span>Example:</span> <!-- <span> important for spacing -->
                <div class="sl-flex sl-flex-1 sl-flex-wrap" style="gap: 4px;">
                            ...
                            <div class="sl-panel__titlebar sl-flex sl-items-center sl-relative focus:sl-z-10 sl-text-base sl-leading-none sl-pr-3 sl-pl-4 sl-bg-canvas-200 sl-text-body sl-border-input focus:sl-border-primary sl-select-none">
                                <div class="sl-flex sl-flex-1 sl-items-center sl-h-lg">
                                    ...
                                    <div class="sl-px-0 sl-py-1">
                                        <div style="max-height: 400px;" class="sl-overflow-y-auto sl-rounded">
                                            <pre><code class="language-bash">curl --request POST \
    "http://tasksync.test/api/auth/login" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json" \
    --data "{
    \"email\": \"gbailey@example.net\",
...
fetch(url, {
    ...
    body: JSON.stringify(body),
                                    ...
                                    <div class="sl-px-0 sl-py-1">
                                        <div style="max-height: 400px;" class="sl-overflow-y-auto sl-rounded">
                                            <pre><code class="language-php">$client = new \GuzzleHttp\Client();
$url = 'http://tasksync.test/api/auth/login';
$response = $client-&gt;post(
    $url,
    [
        'headers' =&gt; [
...
.catch(error =&gt; {
    ...
    <div class="sl-stack sl-stack--vertical sl-stack--5 sl-flex sl-flex-col sl-items-stretch">
        ...
        <div class="sl-relative">
            <div title="http://tasksync.test/api/auth/logout"
                     class="sl-stack sl-stack--horizontal sl-stack--3 sl-inline-flex sl-flex-row sl-items-center sl-max-w-full sl-font-mono sl-py-2 sl-pr-4 sl-bg-canvas-50 sl-rounded-lg"
                >
                                            <div class="sl-text-lg sl-font-semibold sl-px-2.5 sl-py-1 sl-text-on-primary sl-rounded-lg"
                             style="background-color: black;"
    ...
    <div class="sl-stack sl-stack--vertical sl-stack--1 sl-flex sl-flex-1 sl-flex-col sl-items-stretch sl-max-w-full sl-ml-2 ">
        <div class="sl-flex sl-items-center sl-max-w-full">
                ...
                <div class="sl-flex sl-flex-1 sl-flex-wrap" style="gap: 4px;">
                    <div class="sl-max-w-full sl-break-all sl-px-1 sl-bg-canvas-tint sl-text-muted sl-rounded sl-border">
                        Bearer 1|331Ixp7FInIkuZjI3RH4f6QrZCSCyDUMTk4IWYnh212eba86
                    </div>
                </div>
            </div>
            </div>
                            ...
                            <div class="sl-flex sl-flex-1">
                                <div class="sl-input sl-flex-1 sl-relative">
                                    ...
                                    <input aria-label="Authorization"
                                           ...
                                           data-prefix="Bearer "
                                           name="Authorization"
                                           placeholder="1|331Ixp7FInIkuZjI3RH4f6QrZCSCyDUMTk4IWYnh212eba86"
                            ...
                            <div class="sl-panel__titlebar sl-flex sl-items-center sl-relative focus:sl-z-10 sl-text-base sl-leading-none sl-pr-3 sl-pl-4 sl-bg-canvas-200 sl-text-body sl-border-input focus:sl-border-primary sl-select-none">
                                <div class="sl-flex sl-flex-1 sl-items-center sl-h-lg">
                                    ...
                                    <div class="sl-px-0 sl-py-1">
                                        <div style="max-height: 400px;" class="sl-overflow-y-auto sl-rounded">
                                            <pre><code class="language-bash">curl --request POST \
    "http://tasksync.test/api/auth/logout" \
...
fetch(url, {
    ...
    headers,
                                    ...
                                    <div class="sl-px-0 sl-py-1">
                                        <div style="max-height: 400px;" class="sl-overflow-y-auto sl-rounded">
                                            <pre><code class="language-php">$client = new \GuzzleHttp\Client();
$url = 'http://tasksync.test/api/auth/logout';
$response = $client-&gt;post(
    $url,
    [
        'headers' =&gt; [
...
.catch(error =&gt; {
    ...
    <div class="sl-stack sl-stack--vertical sl-stack--5 sl-flex sl-flex-col sl-items-stretch">
        ...
        <div class="sl-relative">
            <div title="http://tasksync.test/api/users"
                     class="sl-stack sl-stack--horizontal sl-stack--3 sl-inline-flex sl-flex-row sl-items-center sl-max-w-full sl-font-mono sl-py-2 sl-pr-4 sl-bg-canvas-50 sl-rounded-lg"
                >
                                            <div class="sl-text-lg sl-font-semibold sl-px-2.5 sl-py-1 sl-text-on-primary sl-rounded-lg"
...
You can check the Dev Tools console for debugging information.</p>
    ...
    --get "http://tasksync.test/api/users" \
    --header "Authorization: Bearer 1|331Ixp7FInIkuZjI3RH4f6QrZCSCyDUMTk4IWYnh212eba86" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre>                                        </div>
                                    </div>
...
fetch(url, {
    ...
    headers,
                                    ...
                                    <div class="sl-px-0 sl-py-1">
                                        <div style="max-height: 400px;" class="sl-overflow-y-auto sl-rounded">
                                            <pre><code class="language-php">$client = new \GuzzleHttp\Client();
$url = 'http://tasksync.test/api/users';
$response = $client-&gt;get(
    $url,
    [
        'headers' =&gt; [
...
.catch(error =&gt; {
    ...
    <div class="sl-stack sl-stack--vertical sl-stack--5 sl-flex sl-flex-col sl-items-stretch">
        ...
        <div class="sl-relative">
            <div title="http://tasksync.test/api/users/{id}"
                     class="sl-stack sl-stack--horizontal sl-stack--3 sl-inline-flex sl-flex-row sl-items-center sl-max-w-full sl-font-mono sl-py-2 sl-pr-4 sl-bg-canvas-50 sl-rounded-lg"
                >
                                            <div class="sl-text-lg sl-font-semibold sl-px-2.5 sl-py-1 sl-text-on-primary sl-rounded-lg"
                             style="background-color: green;"
